@extends('layouts.vertical', ['page_title' => 'Data Pengaduan', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end my-3">
                            <a href="{{ route('pengaduan.create') }}" class="btn btn-primary"><i class="ri-pages-fill"></i> Tambah Pengaduan</a>
                        ...
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $d->judul }}</td>
                                    <td>{{ $d->topik->nama }}</td>
                                    <td>{{ ucfirst($d->status_layanan)  }}</td>
                                    <td>{{ $d->is_public == 1 ? 'Ya' : 'Tidak' }}</td>
                                    <td><a href="{{ route('pengaduan.edit', $d->id) }}" class="btn btn-primary btn-sm">Detail</a></td>
                                </tr>
                                @endforeach
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <h4 class="mt-3">Pengaduan baru berhasil dibuat</h4>
                        </div>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
